...
see clear, specific evidence that contradicts this.
  • A score of 1 or 2 requires no justification.
  • A score of 3 means you are genuinely uncertain.
  • A score of 4 requires you to identify WHICH item was \
affected and describe HOW it changed relative to nearby \
items.
  • A score of 5 requires clear, sustained evidence across \
