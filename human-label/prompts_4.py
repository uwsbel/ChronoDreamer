"""
Prompt definitions for VLM-as-judge collision evaluation (v4).

Changes from prompts_3.py (v3):
  - COMMON_HEADER: Added instruction in SCENE section that context frames
    establish scene layout -- use them to identify items and their arrangement.
  - CONTACT_ADDENDUM: unchanged from v3.
  - P1-P5 bodies: unchanged from v3.
