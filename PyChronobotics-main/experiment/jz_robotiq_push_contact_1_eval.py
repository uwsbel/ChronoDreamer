...
flashlight0 = assets_importer.flashlight(chrono.ChVector3d(0.23, 0.51, 0.02), collidable=True)
flashlight0.SetName("flashlight0")
gripper.add_object("flashlight0")

flashlight1 = assets_importer.flashlight(chrono.ChVector3d(-0.2, 0.6, 0.02), collidable=True)
flashlight1.SetName("flashlight1")
gripper.add_object("flashlight1")

flashlight2 = assets_importer.flashlight(chrono.ChVector3d(0.15, 0.57, 0.02), collidable=True)
flashlight2.SetName("flashlight2")
gripper.add_object("flashlight2")

flashlight3 = assets_importer.flashlight(chrono.ChVector3d(-0.14, 0.64, 0.02), collidable=True)
flashlight3.SetName("flashlight3")
gripper.add_object("flashlight3")

flashlight4 = assets_importer.flashlight(chrono.ChVector3d(0.0, 0.48, 0.02), collidable=True)
flashlight4.SetName("flashlight4")
gripper.add_object("flashlight4")

soda_can_0 = assets_importer.sodacan(chrono.ChVector3d(0.05, 0.75, 0.06), collidable=True)
soda_can_0.SetName("soda_can_0")
gripper.add_object("soda_can_0")

soda_can_1 = assets_importer.sodacan(chrono.ChVector3d(-0.05, 0.75, 0.06), collidable=True)
soda_can_1.SetName("soda_can_1")
gripper.add_object("soda_can_1")

soda_can_2 = assets_importer.sodacan(chrono.ChVector3d(0.12, 0.80, 0.06), collidable=True)
soda_can_2.SetName("soda_can_2")
gripper.add_object("soda_can_2")

soda_can_3 = assets_importer.sodacan(chrono.ChVector3d(-0.14, 0.78, 0.06), collidable=True)
soda_can_3.SetName("soda_can_3")
gripper.add_object("soda_can_3")

soda_can_4 = assets_importer.sodacan(chrono.ChVector3d(-0.2, 0.68, 0.06), collidable=True)
soda_can_4.SetName("soda_can_4")
gripper.add_object("soda_can_4")

soda_can_5 = assets_importer.sodacan(chrono.ChVector3d(0.2, 0.68, 0.06), collidable=True)
soda_can_5.SetName("soda_can_5")
gripper.add_object("soda_can_5")
...
items_of_interest.append(flashlight4)
...
items_of_interest.append(soda_can_5)
